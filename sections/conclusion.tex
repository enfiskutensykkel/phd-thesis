...
\end{itemize}
%
Finally, possibilities that become enabled by future interconnection technologies that are built on \gls{pcie} should be explored once they become widely available.
%
Particularly \gls{cxl} is interesting with regard to memory \gls{disaggregation}, as it provides new cache-coherent protocols for accessing system and device memory.
