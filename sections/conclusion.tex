...
%
This additional complexity makes it infeasible to rely only on \glspl{ntb} alone to implement a resource sharing solution, as it would require extensive modifications to existing software.
...
%
As such, SmartIO provides a logical decoupling of devices and which \glspl{lendermachine} they are installed in, solving the challenge of managing multiple address spaces.



Our SmartIO framework supports three different methods of resource sharing:
%
\begin{itemize}
...
Something something mapping in advance?
