...
The main goal of this dissertation was to develop a framework for sharing and distributing \gls{io} resources,~i.e., devices and memory, in a way that eliminates the distinction between local and remote access.
%
We stated the following research question: \researchquestion
...
% We should also link each objective to the list of contributions in 1.5
