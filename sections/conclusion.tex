...
%
\Gls{p2p} can also be enabled by using the \gls{apiext}, by mapping \glspl{devicebar} for \emph{another device}.
%
The \gls{nvme} driver experiment presented in \cref{sec:eval-nvme} demonstrates this.
