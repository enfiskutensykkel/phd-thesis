...
\begin{itemize}
    ...
    \item 
        ...
        %
        However, both \glspl{gpu} are included as destinations in our experiment, for the purpose of showcasing the capabilities of SmartIO.\footnote{A similar experiment is also presented in \paperref{tocs:eval-nvme-sq}, where only the local \gls{gpu} is used as a data destination.}
...
Our \gls{nvme} driver experiment also shows that the different sharing methods of SmartIO can be \emph{combined}. 
%
