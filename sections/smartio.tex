...
%
Regardless, sharing devices with \glspl{vm} should \emph{also} be supported.
...
% TODO: Section about the challenges of MDEV
% - Mapping all of VM memory in order to avoid requiring specialized guest driver
