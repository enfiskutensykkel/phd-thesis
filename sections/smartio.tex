...
%
At its core, SmartIO is a framework for sharing \gls{io} resources and facilitating remote access, 
%
However, as a complete solution consisting of several components, SmartIO relates .

SmartIO has several components that could potentially be discussed at great length in order to place them in proper context.
%
Therefore, we primarily consider
