...
%
To demonstrate this, we have designed an experiment using our SmartIO \gls{nvme} driver to implement the following workload (as illustrated in \cref{fig:eval-nvme-design}):
%
\begin{itemize}
    \item 
        %
...
\end{itemize}
%
This experiment is also presented in \paperref{tocs:eval-nvme-sq}, showing the same performance benefit of moving the \gls{sq} closer to the \gls{nvme}.
%
More context on why \gls{dma} reads are affected by longer distances can be found in \paperref{tocs:eval-lending-path}.
