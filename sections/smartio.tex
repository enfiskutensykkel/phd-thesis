...
%
It is even possible to migrate \glspl{vm} any \gls{host} in the cluster, as devices are assigned to \glspl{vm} using device identifiers and dynamically borrowed and returned.
