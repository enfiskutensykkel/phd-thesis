...
%
For more details on \gls{pcie}, please refer to \paperref{tocs:pcie}, as well as \paperref{cc:pcie}.
...
%
For more details on \glspl{ntb} and \gls{pcie} in general, please refer to the published papers, particularly \paperref{tocs:pcie}.
...
\begin{enumerate}
    ...
    \item \textbf{Resource abstraction mechanism}: As addressed in \cref{sec:idea} ...
