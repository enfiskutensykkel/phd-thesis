...
%
\begin{itemize}
    \item So-called ``rack-scale \gls{disaggregation}'' and device sharing by \textbf{logical partitioning}, where modular blade servers are connected to a backplane, or some other shared \gls{io} bus fabric, within a data center rack.
        %
        ...
        %
        \gls{pcie} (with additional virtualization support) is more often used for commercial solutions~\cite{url:liqid,url:gigaio,Chung2018}.
        %
