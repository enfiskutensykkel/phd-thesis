...
%
As part of the description of the implementation of the different components of SmartIO, given in \paperref{tocs:lending,tocs:mdev,tocs:nvme}, we provide a more in-depth explanation of the main challenges and how we have tackled them.
%
Moreover, we provide a discussion of additional considerations that are not mentioned here in \paperref{tocs:disc}.
...
%
This also explains how memory regions (\glspl{bar}) of \emph{other} devices can be mapped for a device, even when they reside in a different lender machine.
