...
The \glspl{bar} of a device is exported as \glspl{sharedsegment} by the SmartIO driver, as briefly mentioned in \cref{sec:smartio-driver}.
%
These \gls{bar} segments can be mapped by the application, providing access to device registers and other device memory.
%
...
%
Similarly, the SmartIO driver also makes it possible to map \gls{memorysegment} for the device.
%
...
%
This makes it possible to make memory locality optimizations

also multicast and other snacks
