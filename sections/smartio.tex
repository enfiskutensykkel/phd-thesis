...
\begin{itemize}
    ...
    \item Memory \gls{disaggregation} through \textbf{remote memory access}.
        %
        The goal of memory \gls{disaggregation} solutions is making more resources available or improving resource utilization, but rather to facilitate shared-memory communication for distributed cluster applications.
        %
        Remote memory access is generally implemented on top of \gls{rdma}, and made available to applications through typical parallel programming models, such as \gls{mpi}~\cite{Jiang2004} and \gls{rpc}~\cite{Lu2013}, or through more explicit abstractions~\cite{Aguilera2018}.
        %
...
Shim~et~al.~\cite{Shim2018,Lim2019} have proposed a solution using \gls{pcie} switch chips to develop \gls{ntb} adapter cards and connected three machines in a cluster.
%
