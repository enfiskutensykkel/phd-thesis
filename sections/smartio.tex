...
Most important is the SmartIO driver's responsibility of mapping \glspl{memorysegment} \textbf{on behalf of a device}.
%
...
%
As mentioned in \cref{sec:challenges}, unlike \glspl{devicebar} and \gls{msi} addresses, \gls{dma} buffer addresses is generally not known in advance.
%
...
A technical description of the implementation of \gls{dl} can be found in \paperref{tocs:lending}, including details about the \gls{shadowdev} and \glspl{cfgcycle}.
%
