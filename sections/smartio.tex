...
%
The results demonstrate that by moving \gls{sq} memory closer to the \gls{nvme} reduces the latency, because the distance the \gls{nvme} has read across shrinks:
%
\begin{itemize}
