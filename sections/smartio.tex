...
%
\begin{itemize}
    \item In \paperref{nossdav:eval}, the initial \gls{dl} implementation is evaluated using \gls{dma} transfer experiments using an Nvidia \gls{gpu}, comparing the performance to a \gls{pcie}-based \gls{rdma} implementation.
