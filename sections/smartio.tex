...
%
Similarly, the we also allow \glspl{memorysegment} to be mapped for a device, allowing devices may use native \gls{dma} to access \gls{sharedsegment} directly.
%
These \glspl{segment} can be in \gls{ram} of the \gls{lender}, the \gls{borrower}, or a different cluster machine entirely.
%
