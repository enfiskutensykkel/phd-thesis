...
%
However, as the purpose of the test is \emph{not} to benchmark the \gls{nvme} itself, but rather any potential overhead of our \gls{dl} sharing method, we used a prototype \gls{ram} disk with an \gls{nvme} controller from Microsemi.
%
