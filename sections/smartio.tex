...
Our proof-of-concept \gls{nvme} driver demonstrate how 


for making device drivers part of distributed, shared-memory applications:
...
%see papers for running the nvme driver on the gpu as a cuda kernel
%multicasting
%failover
