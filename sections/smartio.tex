...
%
A segment can even be allocated in device memory of another device.
%
...
%
In practice, all memory used by the \gls{vmemulator} application must be mapped for the device, as a device driver or application running in the \gls{guest} may try to use any \gls{guestphys} address when interacting with the device.
%
