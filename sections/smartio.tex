...
Shim~et~al.~\cite{Shim2018} have proposed a solution have used \gls{pcie} switch chips to develop \gls{ntb} adapter cards and connected three machines in a cluster~\cite{Lim2019,Shim2018}.
        %
     ...
     The Ladon system~\cite{Tu2013,Tu2018} is a solution that is very similar 
