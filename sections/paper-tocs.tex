...
\begin{description}
	...
	\item[Candidate's contributions:]
		...
		%
		Markussen wrote most of the text for the paper, and also write the necessary tools and benchmarking programs for the evaluation,
		including the \acrshort{fio} integration for the \acrshort{nvme} driver and improving the \acrshort{gpu} \acrshort{p2p}
		test programs.
