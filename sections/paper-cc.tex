...
\begin{description}
	...
	\item[Candidate's contributions:]
		...
		%
		Markussen was responsible for investigating performance bottlenecks and identified weak areas,
		and he contributed to improving the overall performance for both Device~Lending and \acrshort{mdev}.
		%
		...
		%
		Markussen wrote most of the text for this paper, and also improved the \acrshort{gpu} benchmarking programs used
