...
%
our solution of utilizing inherent memory-mapping capabilities of \glspl{ntb} to develop a mechanism for making resources appear and behave exactly as if they were part of the local device tree, we a
...
thus eliminating any distinction between remote and local 

that attempts to unify traditional device \gls{io} with distributed, shared-memory computing.
%
...
As such, it is desirable to realize this solution by \textbf{building a working prototype}, in order to be able to explore potential opportunities and weaknesses along the way.
%
Part of
