...
%
Even though \gls{passthrough} allows the device to be used directly by a \gls{guest} driver, requiring that application software can only run in \glspl{vm} inevitably adds additional \gls{cpu} load.
%
