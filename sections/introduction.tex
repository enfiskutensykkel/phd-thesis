...
\end{restatable}
%
In particular, this research question can be broken down into the following requirements:
%
...
Among computer scientists, there is a long-standing philosophical debate regarding whether the field of computer~science should be considered a branch of mathematics, an engineering discipline, or a natural science.
%
According to Eden~\cite{Eden2007}, computer~science as discipline can be divided into three paradigms:
\begin{itemize}
    \item Rationalist: defines computer~science as a branch of mathematics. 
        The paradigm seeks a~priori knowledge of systems through means of deductive reasoning.
    \item Technocratic: defines computer~science as an engineering discipline.
        The paradigm seeks probable, a~posteriori knowledge about systems through implementation and testing.
    \item Scientific: defines computer~science as a natural (empirical) science.
        The paradigm seeks both a~priori and a~posteriori knowledge about systems by combining formal deduction and scientific experimentation.
        Note that the technocratic process of ``testing'' differs from scientific experiments, in that the purpose of the former is to establish to which extent a set of requirements are met, whereas the latter is designed to corroborate (or refute) a hypothesis.
\end{itemize}
A similar classification of paradigms is supported by the ACM Task Force on the Core of Computer Science~\cite{Comer1989}. 
%
They additionally note that because computer~science, with its own theory, experimental method, and engineering of systems, is so deeply rooted into both mathematics and engineering, not any one of the paradigms can be said to be fundamental to the discipline.

% different subareas fall into one of these paradigms
