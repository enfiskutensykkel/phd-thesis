...
%
Furthermore, by relying on native \gls{pcie}, our system not only supports sharing of all types of \gls{pcie} devices, but also allows remote resources to be accessed with performance comparable to accessing a local device.
%
...
%
Devices or memory may even be \lgls{disaggregation}{disaggregated} and shared with several machines simultaneously, without requiring virtualization support in device hardware or a complex software infrastructure.
