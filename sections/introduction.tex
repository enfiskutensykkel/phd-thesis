...
%
Therefore, we follow the technocratic paradigm by iteratively designing, implementing, and testing a solution according to the requirements and objectives given in \cref{sec:problem}:
%
\begin{itemize}
    \item 
