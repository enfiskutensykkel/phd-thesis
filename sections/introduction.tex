...
%
Such instances are evaluation scenarios involving devices with multiple device functions,~i.e., \gls{sriov}, and experiments \lgls{disaggregation}{disaggregating} device and memory resources in software.
