...
\section{Outline}
This dissertation describes the design, implementation, and evaluation of the SmartIO system for efficient sharing of resources between \gls{pcie}-networked computers.
%
The entire SmartIO system is described in detail in \cref{paper:tocs}, with the individual components explained in \crefrange{paper:nossdav}{paper:cc}.
%
The rest of this dissertation is organized as follows:
%
\begin{description}
    \item[\cref{chapter:smartio}]
        gives a brief summary of the SmartIO system.
        %
    ...
    \item[\cref{paper:tocs}]
        presents the entire SmartIO system as a whole, including the final iterations of the Device~Lending and \gls{mdev} components.
        %
