...
%
Although we could use virtualization to hide the fact that devices are on the other side of an \gls{ntb}~\cite{Tu2013}, relying on \glspl{vm} to mitigate complexity forgoes the possibility of using bare-metal machines for processing.
%
