...
%
No single one of the paradigms can therefore be said to be fundamental to computer~science on its own, and the distinction between them is inherently fuzzy.
...
%
The different iterations our solution has gone through in order to better satisfy the requirements are seen in \crefrange{paper:nossdav}{paper:tocs}.
%
