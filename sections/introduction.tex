...
In cloud computing environments, dynamically scaling \gls{io} resources is often accomplished through virtualization. 
%
...
%
Since all memory address translations are done in the \gls{ntb} hardware, very low latency memory-to-memory communication is supported~\cite{Lim2019,Tu2014}.
