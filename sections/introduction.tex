...
%
However, we consider this to be outside the scope of this dissertation, and we only focus on the fundamental mechanisms.
...
One of the central motivations of our framework is that both \gls{host}~machines and \glspl{vm} should be able to use shared devices.
%
...
The framework should support sharing of \gls{pcie}-attached resources, such as devices and memory resources, without requiring any modifications to existing device driver implementations or application software~(\cref{obj:transparent}).
%
Th
