...
\begin{figure}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=.78\linewidth]{direct-access-rdma}
        \caption{Accessing remote resources over traditional network using \glsxtrshort{rdma}.}
    \end{subfigure}
    \par\vspace{5mm}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=.78\linewidth]{direct-access-smartio}
...
%
Even so, it should be pointed out that the ideas and concepts of our work are general, and can in fact be implemented for \emph{any} \gls{ntb} hardware that has similar capabilities.
