...
%
Consequently, \lgls{disaggregation}{disaggregating} a device and sharing it with multiple machines at the same time requires either alternative methods, like \gls{rdma}, or additional virtualization support in the device itself,~i.e., \gls{sriov}.
...
While approaches using fabric partitioning can be said to enable a composable \gls{io} infrastructure, they stop short of providing \emph{networking} capabilities over \gls{pcie}.
%
