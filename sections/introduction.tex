...
%
As such, it was desirable to realize this solution by building a working prototype, in order to be able to explore potential opportunities and weaknesses along the way.
%
...
To provide a complete evaluation, the solution must be thoroughly tested:
%
\begin{itemize}
    ...
    \item \textbf{Exploratory testing \& experimentation}: 
        Par of the evaluation should be to identify and explore new possibilities that are enabled by the solution.
        %
