...
%
While all three paradigms can be applied to these sub-areas, it is the technocratic paradigm which lends itself best to answering our research~question~(\cref{question}).
%
Neither the rationalist or scientific paradigms are particularly well-suited in this context.
%
...
%
Neither are we attempting to model these existing systems in order to understand some process and make predictions about it.



%something about how engineering in comp sci differs from traditional engineering
Following the technocratic paradigm, we have designed and implemented a solution for making it easier to share \gls{io} resources efficiently among machines in a \gls{pcie} cluster as our prototype.
%according to the requirements and specifications given in \cref{sec:objectives}.
%
...
%
The different iterations this implementation has gone through are seen in \crefrange{paper:nossdav}{paper:tocs}.
