...
\begin{itemize}
    ...
    \item The evaluation should also explore possible optimizations that are enabled by our solution, such as exploiting memory locality to reduce latency or using \gls{pcie} multicasting to replicate data across several machines.
        %
