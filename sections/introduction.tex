...
\begin{itemize}
    \item %\textbf{Functionality testing}: 
        A wide range of functionality tests should be included to prove that the solution is general and does not require any special adaptions.
        %
        ...
        %
        Furthermore, tests should be performed using several different types of devices and device driver implementations.
        %
    ...
    \item %\textbf{Comparison testing}: 
        ...
        %
        Since the solution allows machines to use the internal devices and memory in other (remote) machines as if these resources were locally installed, we can use comparison testing.
        %
    ...
    \item %\textbf{Exploratory testing \& experimentation}: 
        ...
        %
        Performing these tests has the added benefit of showcasing capabilities enabled by our solution that other resource sharing solutions lack.
