...
\begin{itemize}
	\item Contributions to the design of the initial Device~Lending implementation by Lars Bj{\o}rlykke Kristiansen~\cite{Kristiansen2015}, and subsequent improvements to the implementation.
		While the original implementation allowed \glspl{nvme}, \glspl{gpu}, network adapters, and any standard \gls{pcie} device to be distributed to remote systems and used by existing application software and device drivers,
		this work has made 


		without any performance difference compared to local access.


		Improvements to the original Device~Lending implementation by , and reworking this into the complete SmartIO system.

		particularly with regard to eliminating performance bottlenecks and 
...
%
These publications are included in \crefrange{paper:nossdav}{paper:tocs}.
%
