...
%
Such instances are evaluation scenarios involving devices with multiple device functions,~i.e., \gls{sriov}, and experiments with devices are \lgls{disaggregation}{disaggregated} in software.
