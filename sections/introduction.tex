...
%
In theory, by using \glspl{ntb} rather than dedicated servers, or requiring that devices are attached to special switches, we could create distributed, peer-to-peer sharing system;
%
...
%
Moreover, by avoiding centralized servers, the risk of individual machines becoming potential performance bottlenecks is reduced.
