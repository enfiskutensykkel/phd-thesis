...
%
These instances are evaluation scenarios involving devices with multiple device functions (for example \gls{sriov} devices), and experiments with software \lgls{disaggregation}{disaggregated} devices.
