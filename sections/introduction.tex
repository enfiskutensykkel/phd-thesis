...
%
This would allow \emph{all} machines in the cluster to share \emph{all} of their own internal resources. 
%
...
%
The physical location of a resource, as well as the address space layout in the machine it is installed in, must be abstracted away without requiring \glspl{vm} (but \glspl{vm} should, ideally, \emph{also} be supported).
