...
\begin{description}
	...
	\item[Candidate's contributions:]
		...
		%
		He designed and performed the performance evaluation of the Device~Lending method, and also implemented the \gls{gpu} \gls{rdma} benchmark program used for reference.
