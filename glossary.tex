...
\newdualentry{kvm}{KVM}{Linux kernel-based virtual machine hypervisor}
{Software running in the Linux kernel on the host to assist and facilitate a \acrshort{vm} emulator (such as Qemu)}
...
\newglossaryentry{sisci}{
	name={SISCI~API},
	description={Software Infrastructure Shared-Memory Cluster Interconnect \acrshort{api}}
}
