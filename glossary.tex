...
\newglossaryentry{emulator}{
    ...
    text={\glsentryshort{vm}~emulator},
...
\newglossaryentry{trap}{
    name={trap},
    description={A hardware-assisted virtualization mechanism that makes it possible to invoke a routine with higher privileges for certain instructions.}
}
