...
%\NewDocumentCommand{\paperref}{ m m }{\hyperref[#1:#2]{\cref*{#1:#2} of \cref*{#1}}~(\cpageref{#1:#2})}
%\NewDocumentCommand{\paperref}{ m m }{\hyperref[#1:#2]{``\textit{\nameref*{#1:#2}}''}~(\hyperref[#1:#2]{\cref*{#1},~\cref*{#1:#2}}, \cpageref{#1:#2})}
\NewDocumentCommand{\paperref}{ m m }{\hyperref[#2]{\cref*{#2} of \cref*{#1}}~(\cpageref{#2})}
