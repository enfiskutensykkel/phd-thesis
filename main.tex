...
\usepackage{pdfpages}
\usepackage{phdstyle}
\usepackage[toc,acronym,seeautonumberlist,nohypertypes={nolist}]{glossaries}
...
\renewcommand{\gls}[1]{%
    \pgfkeysifdefined{/glskey/#1}{%
        \lgls{\pgfkeysvalueof{/glskey/#1}}{\glsentrytext{nolist-#1}}%
    }{%
        \origgls{#1}%
    }%
}
...
\renewcommand{\glspl}[1]{%
    \pgfkeysifdefined{/glskey/#1}{%
        \lgls{\pgfkeysvalueof{/glskey/#1}}{\glsentryplural{nolist-#1}}%
    }{%
        \origglspl{#1}%
    }%
}
