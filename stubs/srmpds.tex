...
\begin{description}
	...
	\item[Abstract:]
        ...
        to \lgls{vm}{VM} guests while still retaining the flexibility of virtualization, something that previously required
	...
	\item[Contributed to:]
		\Cref{obj:distributed,obj:transparent,obj:performance,obj:dynamic}.

\end{description}

\includepaper{srmpds}{
	1, section, 1, Introduction, srmpds:intro,
	2, section, 1, PCIe overview, srmpds:pcie,
	2, subsection, 2, Memory addressing and forwarding, srmpds:pcie-addr,
	2, subsection, 2, Virtualization support and pass-through, srmpds:pcie-virt,
	3, subsection, 2, Non-transparent bridging, srmpds:pcie-ntb,
	3, section, 1, Related work, srmpds:rw,
	3, subsection, 2, Distributed IO using RDMA, srmpds:rw-rdma,
	3, subsection, 2, Virtualization approaches, srmpds:rw-virt,
	3, subsection, 2, Partitioning the fabric, srmpds:rw-part,
	4, section, 1, Device Lending, srmpds:lending,
	5, section, 1, Supporting virtual borrowers, srmpds:mdev,
	6, section, 1, Multi-device interoperability, srmpds:p2p,
	6, section, 1, Performance evaluation, srmpds:eval,
	6, subsection, 2, IOMMU performance penalty, srmpds:eval-iommu,
	7, subsection, 2, Pass-through comparison, srmpds:eval-mdev,
	7, subsection, 2, Device-to-device evaluation, srmpds:eval-p2p,
	%8, subsubsection, 3, Bandwidth, srmpds:eval-p2p-bw,
	%8, subsubsection, 3, Latency, sec;srmpds-eval-p2p-lat,
	9, section, 1, Discussion and conclustion, srmpds:concl
}
